...
Provides functions for creating server and client sockets, sending and receiving packets in a C networking program. This file contains functions for handling sockets in a C networking program, including\+:  
