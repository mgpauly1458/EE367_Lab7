\hypertarget{switch__util_8h}{}\doxysection{src/switch\+\_\+util.h File Reference}
\label{switch__util_8h}\index{src/switch\_util.h@{src/switch\_util.h}}
\doxysubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{switch__util_8h_afce601001ec65f0c70e66d4d892c8598}{display\+\_\+port\+\_\+info}} (struct \mbox{\hyperlink{structnet__port}{net\+\_\+port}} $\ast$p)
\begin{DoxyCompactList}\small\item\em Displays the information of a network port. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{switch__util_8h_a37372a9410c82b61a7cf96b68a4d15e6}{display\+\_\+forward\+\_\+table}} (struct \mbox{\hyperlink{structforward__table}{forward\+\_\+table}} table)
\begin{DoxyCompactList}\small\item\em Displays the forwarding table. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{switch__util_8h_a12bce235e4afcb5132e038aca6d02acc}{init\+\_\+forward\+\_\+table}} (struct \mbox{\hyperlink{structforward__table}{forward\+\_\+table}} $\ast$table)
\begin{DoxyCompactList}\small\item\em Initializes the forwarding table. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{switch__util_8h_a15be314046a17a16358977615932c8b3}{add\+\_\+src\+\_\+to\+\_\+table}} (struct \mbox{\hyperlink{structforward__table}{forward\+\_\+table}} $\ast$table, struct \mbox{\hyperlink{structpacket}{packet}} $\ast$pkt, int port\+\_\+index)
\begin{DoxyCompactList}\small\item\em Adds a source host to the forwarding table. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{switch__util_8h_ac7bee0714142048122df1ea64d0aa5de}{send\+\_\+to\+\_\+all\+\_\+ports}} (int node\+\_\+port\+\_\+num, struct \mbox{\hyperlink{structnet__port}{net\+\_\+port}} $\ast$$\ast$node\+\_\+port, struct \mbox{\hyperlink{structpacket}{packet}} $\ast$pkt)
\begin{DoxyCompactList}\small\item\em Sends a packet to all network ports. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{switch__util_8h_aa649a10255d1dc2492f80d519ea105f0}{is\+\_\+host\+\_\+in\+\_\+table}} (struct \mbox{\hyperlink{structforward__table}{forward\+\_\+table}} $\ast$table, char dst)
...
\mbox{\Hypertarget{switch__util_8h_a15be314046a17a16358977615932c8b3}\label{switch__util_8h_a15be314046a17a16358977615932c8b3}} 
\index{switch\_util.h@{switch\_util.h}!add\_src\_to\_table@{add\_src\_to\_table}}
\index{add\_src\_to\_table@{add\_src\_to\_table}!switch\_util.h@{switch\_util.h}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{switch__util_8h_a37372a9410c82b61a7cf96b68a4d15e6}\label{switch__util_8h_a37372a9410c82b61a7cf96b68a4d15e6}} 
\index{switch\_util.h@{switch\_util.h}!display\_forward\_table@{display\_forward\_table}}
\index{display\_forward\_table@{display\_forward\_table}!switch\_util.h@{switch\_util.h}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{switch__util_8h_afce601001ec65f0c70e66d4d892c8598}\label{switch__util_8h_afce601001ec65f0c70e66d4d892c8598}} 
\index{switch\_util.h@{switch\_util.h}!display\_port\_info@{display\_port\_info}}
\index{display\_port\_info@{display\_port\_info}!switch\_util.h@{switch\_util.h}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{switch__util_8h_a12bce235e4afcb5132e038aca6d02acc}\label{switch__util_8h_a12bce235e4afcb5132e038aca6d02acc}} 
\index{switch\_util.h@{switch\_util.h}!init\_forward\_table@{init\_forward\_table}}
\index{init\_forward\_table@{init\_forward\_table}!switch\_util.h@{switch\_util.h}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{switch__util_8h_aa649a10255d1dc2492f80d519ea105f0}\label{switch__util_8h_aa649a10255d1dc2492f80d519ea105f0}} 
\index{switch\_util.h@{switch\_util.h}!is\_host\_in\_table@{is\_host\_in\_table}}
\index{is\_host\_in\_table@{is\_host\_in\_table}!switch\_util.h@{switch\_util.h}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{switch__util_8h_ac7bee0714142048122df1ea64d0aa5de}\label{switch__util_8h_ac7bee0714142048122df1ea64d0aa5de}} 
\index{switch\_util.h@{switch\_util.h}!send\_to\_all\_ports@{send\_to\_all\_ports}}
\index{send\_to\_all\_ports@{send\_to\_all\_ports}!switch\_util.h@{switch\_util.h}}
